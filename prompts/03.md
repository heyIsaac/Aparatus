No componente @app/\_components/service-item.tsx, ao clicar em "Reservar" abra o sheet que está em https://www.figma.com/design/pJlQZvNkkqG4zUyowMuFtf/Aparatus-%7C-Alunos--Copy-?node-id=78-1818&m=dev usando o componente Sheet do shadcn.

Use o componente Calendar do shadcn para renderizar o calendário.

Ao clicar em um dia do calendário, exiba horários fixos(das 09h às 18h, de meia em meia hora; Exemplos: 09:00, 09:30, 10:00).
